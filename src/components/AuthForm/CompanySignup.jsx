...
import { useCreateCompany } from "@hooks/useCreateCompany.hook"
import { useCompanySignupFormValidation } from "@hooks/FormValidations/companySignupFormValidation.schema"
		...
		<div>
			<form onSubmit={formik.handleSubmit} className="w-full">
				<label htmlFor="name" className="flex flex-col">
					<span className=" text-xs font-medium text-light-gray">Company Name</span>
					<input
						className={
