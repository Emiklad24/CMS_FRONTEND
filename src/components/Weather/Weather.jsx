...
const Weather = () => {
  return (
    <div className="flex flex-col items-center p-8 rounded-md w-60 sm:px-12 dark:bg-coolGray-900 dark:text-coolGray-100">
      <div className="text-center">
        <h2 className="text-xl font-semibold">Dubai</h2>
        <p className="text-sm dark:text-coolGray-400">July 29</p>
      </div>
      ...
      <p className="dark:text-coolGray-400">Partly cloudy</p>
</div>
  )
}
