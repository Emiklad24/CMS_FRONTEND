...
const SuccessToast = (props) => {
  ...
  return (
    <span className='fixed top-0 right-0'>
        {!showToast ? (
          <div id="toast-success" className="flex items-center w-full max-w-xs p-6 mb-4 text-gray-500 bg-white shadow" role="alert">
            ...
            <button  onClick={handleReset} type="button" className="ml-auto  bg-white text-darkgray hover:text-success p-1.5 inline-flex h-8 w-8" data-dismiss-target="#toast-success" aria-label="Close">
