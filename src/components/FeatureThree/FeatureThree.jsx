			...
			<div className="dark:bg-coolGray-800 dark:text-coolGray-100">
				<div className="px-4 py-16 mx-auto max-w-7xl sm:px-6 lg:px-8">
					<div className="max-w-3xl mx-auto text-center">
						<h2 className="md:text-3xl font-extrabold text-blue-primary text-xl">
							All the features you want
						</h2>
						<p className="mt-4 textdark-gray text-xs md:text-sm">
							Pellentesque viverra, leo id euismod laoreet, nunc risus molestie orci,
							vel faucibus quam justo id mauris.
						</p>
					</div>
					<dl className="mt-12 space-y-10 sm:space-y-0 sm:grid sm:grid-cols-2 sm:gap-x-6 sm:gap-y-12 lg:grid-cols-4 lg:gap-x-8">
						<div className="flex">
							<svg
								...
								stroke="currentColor"
								aria-hidden="true"
								className="flex-shrink-0 w-6 h-6 text-blue-primary"
							>
								<path
									strokeLinecap="round"
							...
							<div className="ml-3">
								<dt className="text-lg font-medium text-blue-primary">
									Quisque at urna
								</dt>
								<dd className="mt-2 text-dark-gray text-xs md:text-sm">
