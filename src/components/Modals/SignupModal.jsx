...
const SignupModal = () => {
	return (
		<>
			<div
				className="w-full py-12 bg-dark-gray bg-opacity-50  transition duration-150 ease-in-out z-10 absolute top-0 right-0 bottom-0 left-0"
				id="modal "
			>
				<div
					role="alert"
					className="container relative mx-auto w-11/12 lg:w-2/3 h-[85vh] bg-white shadow-md rounded overflow-hidden"
				>
					<button
						className="cursor-pointer absolute top-0 right-0 mt-4 mr-5 text-2xl text-dark-gray hover:text-blue-primary transition duration-150 ease-in-out"
						...
						<div className="lg:basis-3/5 w-full">
							<div className="relative py-16 lg:py-8 px-5 lg:px-10 ">
								<div className="flex flex-col  justify-between my-8">
									<h3 className="text-blue-primary text-2xl text-center lg:text-left font-lg font-bold tracking-normal leading-tight mb-2">
										Welcome!
									</h3>
									<h5 className="text-dark-gray text-sm text-center lg:text-left font-lg font-bold tracking-normal leading-tight mb-2">
										Let&apos;s get you started
									</h5>
								</div>

								<h1 className="text-dark-gray text-xl lg:text-2xl text-center lg:text-left font-lg tracking-normal leading-tight mb-4">
