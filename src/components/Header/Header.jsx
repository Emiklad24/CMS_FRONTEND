    ...
    <div className="w-full bg-white shadow-sm z-[50] font-sans">
        ...
        <nav className="flex flex-row justify-between items-center bg-transparent py-4 md:py-2 relative">
          <div className="logo basis-3/4 md:basis-3/6">
            <div className="flex flex-row items-center justify-start">
              ...
              <span className="text-[#1E2B00] uppercase text-xs md:text-sm ml-2">
                <Link href="/"><a>Consultant Management System</a></Link>
              </span>
            </div>
          </div>
          ...
          <div className="md:items-center justify-center md:w-full flex md:basis-1/6">
            <div className="md:flex capitalize text-sm  hidden">
              <Link href="/features">
                <a
                className="text-blue-primary  mx-2 md:mx-4 py-2 relative hoverable"
              >
                Features
              </a>
              </Link>
          ...
          <div className="hidden md:flex md:text-xs capitalize items-center justify-end basis-2/6 text-center">
            <Link href="/signin">
             <a
              className=" md:text-blue-primary  border border-blue-primary px-4 py-2 relative hover:text-white hover:bg-blue-primary"
            ...
            <Link href="/signup">
             <a
              className=" md:text-white bg-blue-primary hover:border hover:border-blue-primary hover:text-blue-primary hover:bg-white ml-4  px-4 py-2 relative"
      ...
      >
        ...
        <div className="accounts flex flex-col items-center justify-center text-center my-12 p-8">
          <Link href="/signin">
           <a
            className="w-full text-blue-primary  border border-blue-primary px-2 py-2 relative hover:text-white hover:bg-blue-primary"
          ...
          <Link href="/signup">
          <a
            className="w-full text-white bg-blue-primary hover:border hover:border-blue-primary hover:text-blue-primary hover:bg-white my-4 px-2 py-2 relative"
